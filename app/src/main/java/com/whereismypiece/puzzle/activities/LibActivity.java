...
import com.whereismypiece.puzzle.adapter.ImageViewAdapter;
import com.whereismypiece.puzzle.interfaces.LoadingListener;
...
//        isPurchase = true;//to test
        ...
        try {
            ...
            imageViewAdapter = new ImageViewAdapter(mListData,getApplicationContext());
            GridLayoutManager gridLayoutManager = new GridLayoutManager(getApplicationContext(),3);
            rvData.setLayoutManager(gridLayoutManager);
            rvData.setAdapter(imageViewAdapter);
